...
type Colaborador struct {
	...
	ConjugeDataNascimento string                  `json:"conjugeDataNascimento,omitempty" bson:"conjugeDataNascimento,omitempty"`
	ConjugeDependente     bool                    `json:"conjugeDependente,omitempty" bson:"conjugeDependente,omitempty"`
